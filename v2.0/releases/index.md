...
| Component                     | Version                                                                                    |
|-------------------------------+--------------------------------------------------------------------------------------------|
| felix                         | [2.0.0-rc2](https://github.com/projectcalico/felix/releases/tag/2.0.0-rc2)           |
| calicoctl                     | [v1.0.0-rc1](https://github.com/projectcalico/calico-containers/releases/tag/v1.0.0-rc1) |
| calico/node                   | [v1.0.0-rc1](https://github.com/projectcalico/calico-containers/releases/tag/v1.0.0-rc1) |
| calico/cni                    | [v1.5.2](https://github.com/projectcalico/calico-cni/releases/tag/v1.5.2)                  |
| libcalico                     | [v0.18.0](https://github.com/projectcalico/libcalico/releases/tag/v0.18.0)                 |
| libcalico-go                  | [v1.0.0-rc2](https://github.com/projectcalico/libcalico-go/releases/tag/v1.0.0-rc2)      |
| calico-bird                   | [v0.1.0](https://github.com/projectcalico/calico-bird/releases/tag/v0.1.0)                 |
| libnetwork-plugin             | [v1.0.0-rc2](https://github.com/projectcalico/libnetwork-plugin/releases/tag/v1.0.0-rc2) |
